...
//                        try {
//                            File storagePath = Environment.getDownloadCacheDirectory();
//                            String path = storagePath + url.getPath();
...
//                .flatMap(new Function<Long, SingleSource<String>>() {
//                    @Override
//                    public SingleSource<String> apply(Long id) throws Exception {
//                        String path = "";
//                        Realm realm = Realm.getInstance(mConfig);
//                        realm.beginTransaction();
